...
import com.example.newsproject.databinding.FragmentHeadlinesBinding
...
class HeadlinesFragment : Fragment(R.layout.fragment_headlines) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemHeadlinesError = view.findViewById(R.id.itenHeadlinesEroor)
            ...
            when(response){
                ...
                is Resource.Error<*> ->{
                    ...
                    response.message?.let { message ->
                        Toast.makeText(activity, "Sorry errory: $message", Toast.LENGTH_LONG).show()
        ...
        retryButton.setOnClickListener {
            newsViewModel.getHeadlines(Constants.COUNTRY_CODE)
        }
